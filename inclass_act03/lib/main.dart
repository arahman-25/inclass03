...
class _ControlDeckScreenState extends State<ControlDeckScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final screenBg = powerLevel < 80 ? 
      Color.lerp(const Color(0xFF1E1F29), const Color.fromARGB(255, 127, 129, 134), powerLevel / 100) : 
      Color.lerp(const Color.fromARGB(255, 127, 129, 134), const Color(0xFF1E1F29), (powerLevel - 80) / 20);
            ...
            Wrap(
              ...
              children: [
                TactileButton(
                  ...
                  onPressed: () => _triggerAction("NITROUS BOOST"),
                ),
                TactileButton(
                ...
                TactileButton(
                  ...
                  isDark: widget.isDark,
                  onPressed: () => _triggerAction("BURNIN' RUBBER"),
                ),
                TactileButton(
                  icon: Icons.pause,
                  label: "PIT STOP",
                  ...
                  isDark: widget.isDark,
                  onPressed: () => _triggerAction("PIT STOP"),
                ),
              ],
            ),
